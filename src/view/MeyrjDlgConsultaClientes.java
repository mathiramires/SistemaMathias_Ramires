 ...
 * @author Marcos
 */
public class MeyrjDlgConsultaClientes extends javax.swing.JDialog {

    /**
     * Creates new form JDlgUsuariosPesquisar
     */

    MeyrControllerConsultasClientes meyrControllerConsultasClientes;
    MeyrClientesDAO meyrClientesDAO;
    
    public MeyrjDlgConsultaClientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Consultar Clientes");
        meyrControllerConsultasClientes = new MeyrControllerConsultasClientes();
        meyrClientesDAO = new MeyrClientesDAO();
        List lista = (List) meyrClientesDAO.listAll();
        meyrControllerConsultasClientes.setList(lista);
        jTable1.setModel(meyrControllerConsultasClientes);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MeyrjDlgConsultaClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MeyrjDlgConsultaClientes dialog = new MeyrjDlgConsultaClientes(new javax.swing.JFrame(), true);
