...
public class MeyrJDlgVendedorPesquisar extends javax.swing.JDialog {
    ...
    private void JBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBtnOkActionPerformed
        ...
        MeyrVendedor meyrVendedor =  (MeyrVendedor) meyrControlerVendedor.getBean( jTable1.getSelectedRow() );
        jDlgVendedor.beanView(meyrVendedor);
...
if (evt.getClickCount() == 2){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MeyrJDlgVendedorPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MeyrJDlgVendedorPesquisar dialog = new MeyrJDlgVendedorPesquisar(new javax.swing.JFrame(), true);
