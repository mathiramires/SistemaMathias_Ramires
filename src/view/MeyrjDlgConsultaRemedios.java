...
import tools.Util;
import view.MeyrControllerConsultasRemedios;
 ...
 * @author Marcos
 */
public class MeyrjDlgConsultaRemedios extends javax.swing.JDialog {

    /**
     * Creates new form JDlgUsuariosPesquisar
     */

    MeyrControllerConsultasRemedios meyrControllerConsultasRemedios;
    MeyrRemediosDAO meyrRemediosDAO;
    
    public MeyrjDlgConsultaRemedios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Consultar Remedios");
        meyrControllerConsultasRemedios = new MeyrControllerConsultasRemedios();
        meyrRemediosDAO = new MeyrRemediosDAO();
        List lista = (List) meyrRemediosDAO.listAll();
        meyrControllerConsultasRemedios.setList(lista);
        jTable1.setModel(meyrControllerConsultasRemedios);
    }
    ...
    private void jBtnConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultaActionPerformed
        ...
        List lista = (List) meyrRemediosDAO.listNomeValor(jTxtNome.getText(),Util.strToDouble(jTxtValor.getText()));
        meyrControllerConsultasRemedios.setList(lista);
        }
        else if(jTxtNome.getText().isEmpty() == false) {
        List lista = (List) meyrRemediosDAO.listNome(jTxtNome.getText());
        meyrControllerConsultasRemedios.setList(lista);
        
        } else if (jTxtValor.getText().isEmpty() == false){
        List lista = (List) meyrRemediosDAO.listValor(Util.strToDouble(jTxtValor.getText()));
        meyrControllerConsultasRemedios.setList(lista);
        }
        else {
        List lista = (List) meyrRemediosDAO.listAll();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            chooser.setSelectedFile(new java.io.File("consulta_remedios.pdf"));
            ...
            doc.add(new Paragraph("Relatório de Remédios Consultados"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MeyrjDlgConsultaRemedios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MeyrjDlgConsultaRemedios dialog = new MeyrjDlgConsultaRemedios(new javax.swing.JFrame(), true);
