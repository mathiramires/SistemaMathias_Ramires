...
public class MeyrJDlgVendasPesquisar extends javax.swing.JDialog {
     ...
     */
    public MeyrJDlgVendasPesquisar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void setTelaPai(MeyrjDlgVendas jDlgVendas) {
    ...
    private void JBtnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBtnOkActionPerformed
        ...
        MeyrVendas vendas = (MeyrVendas) meyrControllerVendas.getBean(linSel);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MeyrJDlgVendasPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MeyrJDlgVendasPesquisar dialog = new MeyrJDlgVendasPesquisar(new javax.swing.JFrame(), true);
